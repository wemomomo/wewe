  ...
  function ensureWorldbookDOM() {
    ...
    if (!container.querySelector('#wbMainContainer')) {
      container.innerHTML = ''
        ...
        + '      <span class="wb-star-node wb-star-top">✦</span>'
        + '      <span class="wb-star-node wb-star-bottom">✦</span>'
        + '      <span class="wb-star-node wb-star-left">✦</span>'
        + '      <span class="wb-star-node wb-star-right">✦</span>'
